...
const About = () => {
  return (
    <>
      <Header />
      <ContentPage>
        <div className="flex flex-col w-full sm:w-[90vw] md:w-[80vw] lg:w-[85vw] xl:w-[80vw] 2xl:w-[75vw] h-full p-5 gap-2 overflow-y-auto text-gray-300 text-base md:text-lg element bg-gradient-to-b from-slate-700 to-gray-900 shadow-xl border-2 border-gray-700">
            <div className="w-full h-auto min-h-[340px] md:min-h-[220px] lg:max-h-[250px] flex flex-col md:flex-row rounded-xl overflow-hidden shadow-lg mt-1 mb-3">
                ...
                >
                    <h1 className="text-3xl lg:text-4xl font-bold text-white mb-3">Ernie Wang</h1>
                    <p className="text-lg lg:text-xl text-gray-100 font-light">Fullstack Developer</p>
                    <p className="text-lg lg:text-xl text-gray-200 mb-3">Musician • Artist • Photographer</p>
            ...
            <div className={infoCard + " flex-col p-4 text-center items-center"}>
                <p className="text-lg text-gray-200 mb-3">Thanks for checking out my website! Here is a older verison of this site! Its pretty terrible right?</p>
            ...
            <div className={infoCard + " flex-col"} style={{background: "linear-gradient(to bottom, rgb(50, 60, 75), rgb(40, 50, 65))"}}>
                <p className="text-sm md:text-base leading-relaxed text-gray-200 m-0">
            ...
            <h2 className="text-4xl text-white mb-1 mt-3 ml-1">Hobbies And Interests</h2>
            <div className={infoCard + " flex-col space-y-4"} style={{background: "linear-gradient(to bottom, rgb(50, 65, 55), rgb(40, 55, 45))"}}>
                <p className="text-sm md:text-base leading-relaxed text-gray-200 m-0">
